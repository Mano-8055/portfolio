...
function LoadingScreen({ onDone }) {
  ...
  const NAME = "MANOBALA";
  const loadLabel =
    pct < 28  ? "Loading environment"  :
    pct < 60  ? "Compiling assets"     :
    pct < 88  ? "Rendering modules"    :
    pct < 100 ? "Finalizing"           : "Complete";
      ...
      <div className="ls-stars" aria-hidden="true">
        {STARS.map((s, i) => (
          <span key={i} className="ls-star" style={{
            ...
            animationDelay: `${s.del}s`, animationDuration: `${s.dur}s`,
          }} />
        ))}
      </div>
          ...
          <div className="ls-name-wrap" style={{ perspective: "500px" }}>
            {NAME.split("").map((ch, i) => (
              <Motion.span
                ...
                transition={{ delay: 0.64 + i * 0.08, duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
...
function JourneySection({ timeline }) {
  ...
  // Auto-advance every 4 s; resets when user picks manually
  useEffect(() => {
    const t = setInterval(() => setActive(i => (i + 1) % timeline.length), 4000);
    return () => clearInterval(t);
  }, [timerKey, timeline.length]);

  const pick = (i) => { setActive(i); setTimerKey(k => k + 1); };
      ...
      <div className="jstage">
        ...
        <div className="jstage-list">
          {timeline.map((item, i) => (
            ...
            >
              <span className="jstage-num">{String(i + 1).padStart(2, "0")}</span>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="jstage-feat-meta">
                <span className="jstage-feat-year" style={{ color: cur.accent }}>{cur.year}</span>
              ...
              {/* Accent divider */}
              <div className="jstage-feat-divider"
                style={{ background: `linear-gradient(90deg, ${cur.accent} 0%, transparent 80%)` }} />
...
function Home() {
  ...
  const stats = [
    { value: "8.4",  label: "CGPA",          icon: <SvgIcon><path d="m12 2 3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></SvgIcon> },
    { value: "2027", label: "Graduation",     icon: <SvgIcon><path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" y1="22" x2="4" y2="15"/></SvgIcon> },
    { value: "10+",  label: "Projects",       icon: <SvgIcon><line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/></SvgIcon> },
  ...
  const timeline = [
    { year: "2022", accent: "#6366f1", title: "Started B.Tech + M.Tech",  desc: "Joined VIT Vellore for Integrated M.Tech in Software Engineering.",
      icon: <SvgIcon><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></SvgIcon> },
    { year: "2025", accent: "#06b6d4", title: "NVIDIA Certification",     desc: "Completed Fundamentals of Deep Learning — NVIDIA DLI.",
      icon: <SvgIcon><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/></SvgIcon> },
    { year: "2026", accent: "#a855f7", title: "React Certification",      desc: "Completed Learn React course on Scrimba.",
      icon: <SvgIcon><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"/><path d="m9 12 2 2 4-4"/></SvgIcon> },
    { year: "2027", accent: "#10b981", title: "Graduation (Target)",      desc: "Completing Integrated M.Tech with strong CGPA and project portfolio.",
      icon: <SvgIcon><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></SvgIcon> },
  ];
            ...
            >
              ...
              <div className="hero-card-profile">
                <div className="hero-card-photo-wrap">
                  <img src={profilePhoto} className="hero-card-photo" alt="Manobala S" />
                </div>
                <div>
              ...
              <div>
                ...
                <p className="hero-card-text">
                  Integrated M.Tech · Software Engineering<br />
                  <span className="hero-highlight">VIT Vellore · CGPA 8.4 · Batch 2027</span>
                </p>
              </div>
              ...
              {/* GitHub link */}
              <a href="https://github.com/Mano-8055" className="hero-card-github" target="_blank" rel="noreferrer">
  ...
  return (
    <Reveal delay={index * 0.06} direction={index % 2 === 0 ? "left" : "right"}>
      <TiltCard className="card card-project" intensity={5}>
        <div className="proj-ghost" style={{ color: accent }}>{year}</div>
        <div className="proj-top">
          <div className="proj-icon-badge" style={{ background: `${accent}1a`, border: `1px solid ${accent}38`, color: accent }}>
            <SvgIcon><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></SvgIcon>
          </div>
          <span className="proj-counter">{String(index + 1).padStart(2,"0")} / {String(total).padStart(2,"00")}</span>
        </div>
        <div className="proj-meta">
          <span className="proj-year-label" style={{ color: accent }}>{year}</span>
          {repo.language && <span className="proj-lang">{repo.language}</span>}
        </div>
        <div className="proj-divider" style={{ background: `linear-gradient(90deg, ${accent}99, transparent)` }} />
        <div className="proj-content">
          <h3 className="proj-name">{repo.name}</h3>
          <p className="proj-desc">{repo.description || "A GitHub project from my portfolio."}</p>
        </div>
        <div className="proj-footer">
          <div className="proj-stats">
            <span className="proj-stat">
              <SvgIcon><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></SvgIcon>
              {repo.stargazers_count}
            </span>
            <span className="proj-stat">
              <SvgIcon><line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/></SvgIcon>
              {repo.forks_count}
            </span>
          </div>
          <div className="proj-links">
            <a href={repo.html_url} target="_blank" rel="noreferrer" className="proj-link">GitHub</a>
            {repo.homepage && <a href={repo.homepage} target="_blank" rel="noreferrer" className="proj-link proj-link-live">Live</a>}
          </div>
        </div>
...
function Projects() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res  = await fetch("https://api.github.com/users/Mano-8055/repos?sort=pushed&direction=desc&per_page=30");
            ...
            <TiltCard className="card proj-spotlight" intensity={3}>
              ...
              <div className="proj-spot-top">
                ...
                <div className="proj-spot-right">
                  <span className="proj-spot-time">Last commit · {timeAgo(featured.pushed_at)}</span>
                  {featured.language && (
              ...
              <p className="proj-spot-desc">{featured.description || "A GitHub project from my portfolio."}</p>

              {/* Actions */}
              <div className="proj-spot-actions">
                <a href={featured.html_url} target="_blank" rel="noreferrer" className="btn btn-primary">View on GitHub</a>
                {featured.homepage && (
                  <a href={featured.homepage} target="_blank" rel="noreferrer" className="btn btn-ghost">Live Demo</a>
                )}
              </div>
            </TiltCard>
          </Motion.div>
            ...
            <>
              ...
              <div className="cards-grid">
                {gridRepos.map((repo, i) => (
                  <ProjCard key={repo.id} repo={repo} index={i} total={gridRepos.length} />
                ))}
              </div>
            </>
          )}
...
function UIUXDesign() {
  const designProcess = [
    { step: "01", accent: "#6366f1", title: "Research",
      icon: <SvgIcon><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></SvgIcon>,
      desc: "User interviews, competitive analysis, and defining pain points to ground every design decision in real needs." },
    { step: "02", accent: "#06b6d4", title: "Wireframe",
      icon: <SvgIcon><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></SvgIcon>,
    ...
    { step: "03", accent: "#a855f7", title: "Prototype",
      icon: <SvgIcon><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></SvgIcon>,
      desc: "Interactive Figma prototypes that simulate the final product experience for early validation and feedback." },
    { step: "04", accent: "#10b981", title: "Deliver",
      icon: <SvgIcon><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></SvgIcon>,
  ...
  const principles = [
    { accent: "#f59e0b", title: "Clarity First",
      icon: <SvgIcon><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></SvgIcon>,
      desc: "Every element earns its place. If it doesn't guide the user, it doesn't stay." },
    { accent: "#22c55e", title: "Accessible by Default",
      icon: <SvgIcon><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></SvgIcon>,
      desc: "WCAG contrast ratios, keyboard navigation, and inclusive design from the very start." },
    { accent: "#ef4444", title: "Performance-Aware",
      icon: <SvgIcon><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></SvgIcon>,
      desc: "Designs that account for loading states, skeletons, and real-world network constraints." },
    { accent: "#6366f1", title: "Component-Driven",
      icon: <SvgIcon><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></SvgIcon>,
            ...
            {designProcess.map((p, i) => (
              <Reveal key={p.step} delay={i * 0.1}>
                <TiltCard className="card process-card" intensity={6}>
                  <div className="process-ghost" style={{ color: p.accent }}>{p.step}</div>
                  <div className="process-top">
                    <div className="process-icon-wrap" style={{ background: `${p.accent}1a`, border: `1px solid ${p.accent}38`, color: p.accent }}>
                      {p.icon}
                    </div>
                  ...
                  <div className="process-bar" style={{ background: p.accent }} />
                </TiltCard>
              </Reveal>
            ))}
          </div>
            ...
            {principles.map((p, i) => (
              <Reveal key={p.title} delay={i * 0.08}>
                <TiltCard className="card principle-card" intensity={6}>
                  <div className="principle-ghost" style={{ color: p.accent }}>{String(i + 1).padStart(2, "0")}</div>
                  <div className="principle-icon-wrap" style={{ background: `${p.accent}1a`, border: `1px solid ${p.accent}38`, color: p.accent }}>
                    {p.icon}
                  </div>
...
function Skills() {
  const skills = [
    { accent: "#6366f1", category: "Programming Languages",
      items: ["Python", "Java"],
      icon: <SvgIcon><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></SvgIcon> },
    { accent: "#06b6d4", category: "Web Development",
    ...
    { accent: "#a855f7", category: "Databases",
      items: ["MySQL", "MongoDB"],
      icon: <SvgIcon><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/><path d="M3 12c0 1.66 4 3 9 3s9-1.34 9-3"/></SvgIcon> },
    { accent: "#f59e0b", category: "Tools",
    ...
    { accent: "#ec4899", category: "Soft Skills",
      items: ["Communication", "Teamwork", "Problem Solving"],
      icon: <SvgIcon><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></SvgIcon> },
  ];
        ...
        {skills.map((s, i) => (
          <Reveal key={s.category} delay={i * 0.07}>
            <TiltCard className="card card-skill" intensity={6}>
              <div className="skill-ghost" style={{ color: s.accent }}>{String(i + 1).padStart(2, "0")}</div>
              <div className="skill-top">
                <div className="skill-icon-wrap" style={{ background: `${s.accent}1a`, border: `1px solid ${s.accent}38`, color: s.accent }}>
                  {s.icon}
                </div>
              ...
              <div className="skill-chips">
                {s.items.map(item => (
                  <span key={item} className="skill-chip" style={{ borderColor: `${s.accent}35` }}>{item}</span>
                ))}
              </div>
            </TiltCard>
          </Reveal>
  ...
  return (
    <Motion.section className="section" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, ease: [0.22,1,0.36,1] }}>
      ...
      <div className="certs-list">
        {CERTS.map((c, i) => (
          <Reveal key={c.title} delay={i * 0.12} direction={i % 2 === 0 ? "left" : "right"}>
            <TiltCard className="card cert-card" intensity={3}>
              {/* Gradient top accent */}
              <div className="cert-accent-line" style={{ background: `linear-gradient(90deg, transparent, ${c.accent} 30%, ${c.accent} 70%, transparent)` }} />

              {/* Ghost year */}
              <div className="cert-ghost" style={{ color: c.accent }}>{c.year}</div>

              {/* Main body */}
              <div className="cert-body">
                {/* Left: icon badge */}
                <div className="cert-icon-wrap" style={{ background: `${c.accent}1a`, border: `1px solid ${c.accent}44`, color: c.accent }}>
                  {c.icon}
                </div>
                ...
                <div className="cert-info">
                  <div className="cert-header">
                    ...
                    <div className="cert-verified" style={{ color: c.accent, borderColor: `${c.accent}40`, background: `${c.accent}12` }}>
                      <SvgIcon><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></SvgIcon>
                      Verified
                    </div>
                  </div>

                  <div className="cert-date-row">
                    <SvgIcon><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></SvgIcon>
                    {c.date}
                  </div>

                  <div className="cert-ids">
                    {c.ids.map(id => (
                      <code key={id} className="cert-id">{id}</code>
                    ))}
                  </div>

                  <div className="cert-footer">
                    <a href={c.link} target="_blank" rel="noreferrer" className="cert-link" style={{ color: c.accent, borderColor: `${c.accent}40`, background: `${c.accent}0f` }}>
                      View Certificate
                      <SvgIcon><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></SvgIcon>
                    </a>
                    <span className="cert-counter">{String(i + 1).padStart(2,"0")} / {String(CERTS.length).padStart(2,"0")}</span>
                  </div>
                </div>
              </div>
            </TiltCard>
...
function Contact() {
  ...
  const contactRows = [
    { label: "Email", value: "shankarmanogym@gmail.com", href: "mailto:shankarmanogym@gmail.com", accent: "#6366f1",
      icon: <SvgIcon><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 7 10-7"/></SvgIcon> },
    { label: "Phone", value: "+91 9626488199", href: "tel:9626488199", accent: "#10b981",
      icon: <SvgIcon><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.18 6.18l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></SvgIcon> },
    { label: "Location", value: "Gudiyatham, Vellore – 632602", href: null, accent: "#f59e0b",
      icon: <SvgIcon><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></SvgIcon> },
    { label: "GitHub", value: "github.com/Mano-8055", href: "https://github.com/Mano-8055", accent: "#a855f7",
      icon: <SvgIcon><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></SvgIcon> },
  ];
          ...
          <div className="card ctc-info-card">
            <div>
              ...
              <p className="ctc-info-desc">
                Open to software engineering internships, freelance web projects, and interesting technical collaborations.
              </p>
            </div>
            <div className="ctc-rows">
              {contactRows.map(row => (
                <div key={row.label} className="ctc-row">
                  <div className="ctc-icon" style={{ background: `${row.accent}1a`, border: `1px solid ${row.accent}38`, color: row.accent }}>
                    {row.icon}
                  </div>
                  <div className="ctc-row-info">
                    <span className="ctc-row-label">{row.label}</span>
                    {row.href
                      ? <a href={row.href} className="ctc-row-value" target={row.href.startsWith("http") ? "_blank" : undefined} rel="noreferrer">{row.value}</a>
          ...
          <form className="card ctc-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="ctc-fields">
              <div className="ctc-field">
                <label>Name</label>
                <input name="user_name" type="text" placeholder="Your name" required disabled={status === "sending" || status === "sent"} />
              </div>
              <div className="ctc-field">
                <label>Email</label>
                <input name="user_email" type="email" placeholder="your@email.com" required disabled={status === "sending" || status === "sent"} />
              </div>
              <div className="ctc-field ctc-field-full">
                <label>Message</label>
                <textarea name="message" rows="5" placeholder="Tell me about your project or opportunity…" required disabled={status === "sending" || status === "sent"} />
              </div>
            </div>
            ...
            <button type="submit" className="btn btn-primary ctc-submit"
              ...
              {status === "sending" ? (
                ...
                <>
                  Send Message
                  <SvgIcon><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></SvgIcon>
                </>
              )}
            </button>
          </form>
    ...
    <footer className="footer">
      ...
      <div className="footer-body">
        <div className="footer-brand">
          ...
          <span className="footer-tagline">Aspiring Software Engineer · VIT Vellore</span>
        ...
        <div className="footer-social">
          <a href="https://github.com/Mano-8055" className="footer-social-link" target="_blank" rel="noreferrer">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.374 0 0 5.373 0 12c0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0 1 12 5.803c1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.627-5.373-12-12-12z"/></svg>
            GitHub
          </a>
          <a href="mailto:shankarmanogym@gmail.com" className="footer-social-link">
          ...
          <a href="tel:9626488199" className="footer-social-link">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.18 6.18l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
            Phone
          </a>
        </div>
      </div>
